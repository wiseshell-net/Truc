...
SpriteLayer::SpriteLayer (const ArraySize& size) :
PArray (size),
Drawable (),
Movable ()
{
...
int
SpriteLayer::draw (SDL_Renderer * const renderer)
{
    DEBUG_FUNCTION_ENTER;
    ...
    if (is_visible)
    {
        for (Sprite * const instance: *this)
        {
            if (instance != nullptr
                && instance->draw (renderer) != ERROR_EXIT_SUCCESS)
            {
...
int
SpriteLayer::draw (SDL_Renderer * const renderer, const Color& color)
{
    DEBUG_FUNCTION_ENTER;
...
void
SpriteLayer::move (const int dx, const int dy)
{
    DEBUG_FUNCTION_ENTER;
...
void
SpriteLayer::moveDirection (const SDL_Point& direction)
{
    DEBUG_FUNCTION_ENTER;
...
void
SpriteLayer::setPosition (const SDL_Point& anchor)
{
    DEBUG_FUNCTION_ENTER;
...
void
SpriteLayer::setPosition (const int anchor_x, const int anchor_y)
{
    DEBUG_FUNCTION_ENTER;
