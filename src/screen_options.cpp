 ...
 * screen_credits.cpp
 *
 * Copyright 2022 Wiseshell Group <contact.wiseshell@gmail.com>
 *
...
#include "screen_options.hpp"
#include "screens.hpp"

#include "geometry.hpp"


ScreenOptions::ScreenOptions (Game& game) :
ScreenBase (game)
{
...
ScreenEnum
ScreenOptions::onExit (ScreenEnum screen)
{
    DEBUG_FUNCTION_ENTER;
