...
#ifndef _SPRITE_LAYER_AREA_ARRAY_HPP
#define _SPRITE_LAYER_AREA_ARRAY_HPP

/**
 * \file
 * \brief Multiple sprite area-constrained layers array management API.
 *
 * This header file declares a minimal API for managing an array of
 * area-constrained layers of sprites.
 *
...
/**
 * \brief Multiple sprite area-constrained layers array management
 * structure.
 *
 * This structure manages an array of pointer references to external
 * sprite area-constrained layer object instances, with garbage
 * collection support.
 *
 */
struct SpriteLayerAreaArray :
    public PArray<SpriteLayerArea *>,
    public Drawable,
    public Movable
{
public:
     ...
     */
    explicit SpriteLayerAreaArray (const ArraySize& size);


    /**
     * \brief Structure destructor.
     */
    virtual ~SpriteLayerAreaArray ();
...
#endif /* _SPRITE_LAYER_AREA_ARRAY_HPP */
