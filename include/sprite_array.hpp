...
#ifndef _SPRITE_ARRAY_HPP
#define _SPRITE_ARRAY_HPP

/**
 * \file
 * \brief Multiple sprites array management API.
 *
...
/**
 * \brief Multiple sprites array management structure.
 *
 * This structure manages an array of internal sprite object instances.
 *
 * \see For external object references, please refer to SpriteLayer
...
public:
     ...
     */
    explicit SpriteArray (const ArraySize& size);
    ...
    /**
     * \brief Moves all sprites at once along with array's internal
     * data.
     */
    virtual void move ();
